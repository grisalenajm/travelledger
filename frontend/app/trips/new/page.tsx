  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="mx-auto max-w-lg px-4 py-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-7 pb-24 md:pb-0">
          ...
          {/* Sticky en móvil para no quedar tapado por el bottom nav */}
          <div className="flex gap-3 sticky bottom-20 md:static
                          bg-background/80 backdrop-blur-xl
                          py-3 -mx-4 px-4 md:mx-0 md:p-0 md:pt-2
                          border-t border-outline-variant/15 md:border-0">
            <Button
              type="button"
              variant="outline"
