      ...
      <div className="mx-auto max-w-2xl px-4 h-14 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="h-8 w-8 rounded-full bg-primary/15 text-primary font-headline font-bold text-sm flex items-center justify-center hover:bg-primary/25 transition-colors"
